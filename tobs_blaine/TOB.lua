...
-- Default door models. A bank can override them with gateModel / vaultModel.
TOB.vaultdoor = "v_ilev_cbankvauldoor01"
TOB.door = "v_ilev_cbankvaulgate01"

-- Banks. To add a bank, copy the B1 block, give it a new name (for example B2) and fill in
-- the coordinates for that bank. See the docs page, "Adding more banks".
TOB.Banks = {
    B1 = { -- Paleto Bay (Blaine County Savings)
        doors = {
